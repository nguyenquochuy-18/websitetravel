...
<div class="notice">
    <span class="glyphicon glyphicon-globe "></span><span id="noticenumb" style="position: absolute; right: 2px;"
        class="badge">0</span>
</div>

<div class="noticepopup" style="display: none;">
    <a class="txtlink" href="#">
        <div class="noticeitem">Bạn hiện không có thông báo mới nào</div>
    </a>
    <a class="txtlink" href="#">
        <div class="noticeitem">Bạn hiện không có thông báo mới nào</div>
    </a>
