    ...
    <section>
        ...
        <ul class="nav nav-stacked nav-pills ">
            ...
            @if (Auth::user()->level == 3 || Auth::user()->level == 4)
                <li class="dropdown"><a data-toggle="dropdown" href="">Loại tin<span
                            class="glyphicon glyphicon-chevron-down navbar-right"></span> </a>
                    <ul class="dropdown-menu">
                        <li><a href="{{ route('admin.loaitin.danhsach') }}">Danh sách </a></li>
                        <li><a href="{{ route('admin.loaitin.them') }}">Thêm</a></li>
                    </ul>
                </li>
                <li class="dropdown"><a data-toggle="dropdown" href=""> Bài viết<span
                            class="glyphicon glyphicon-chevron-down navbar-right"></span> </a>
                    <ul class="dropdown-menu">
                ...
                <li class="dropdown"> <a data-toggle="dropdown" href=""> Khu vực <span
                            class="glyphicon glyphicon-chevron-down navbar-right"></span> </a>
                    <ul class="dropdown-menu">
                ...
                <li class="dropdown"><a data-toggle="dropdown" href="">Comment<span
                            class="glyphicon glyphicon-chevron-down navbar-right"></span> </a>
                    <ul class="dropdown-menu">
            ...
            @endif
            <li class="dropdown"><a data-toggle="dropdown" href=""> User<span
                        class="glyphicon glyphicon-chevron-down navbar-right"></span> </a>
                <ul class="dropdown-menu">
            ...
            @if (Auth::user()->level == 2 || Auth::user()->level == 4)
                <li class="dropdown"><a data-toggle="dropdown" href=""> Khách sạn<span
                            class="glyphicon glyphicon-chevron-down navbar-right"></span> </a>
                    <ul class="dropdown-menu">
                ...
                <li class="dropdown"><a data-toggle="dropdown" href=""> Đơn đặt phòng<span
                            class="glyphicon glyphicon-chevron-down navbar-right"></span> </a>
                    <ul class="dropdown-menu">
                        <li><a href="{{ url('admin/don/dondatphong') }}"> Danh sách </a></li>
                    </ul>
                </li>
                <li class="dropdown"><a data-toggle="dropdown" href=""> Tiện ích<span
                            class="glyphicon glyphicon-chevron-down navbar-right"></span> </a>
                    <ul class="dropdown-menu">
